...
public class BestSellerBooksRecyclerViewAdapter extends RecyclerView.Adapter<BestSellerBooksRecyclerViewAdapter.BookViewHolder> {
    ...
    public void onBindViewHolder(final BookViewHolder holder, int position) {
        ...
        // setText does not accept Integers, only String. rank from the json NYT api is an Integer
        // adding a "" solves this problem
    ...
    public class BookViewHolder extends RecyclerView.ViewHolder {
        ...
        public final TextView mBookRanking; // RA
        public final TextView mBookTitle;
        public final TextView mBookAuthor;
        public final TextView mBookDescription; // RA
        public final ImageView mBookImage; // RA
        public BestSellerBook mItem;

        public BookViewHolder(View view) {
            super(view);
            mView = view;
            mBookRanking = (TextView) view.findViewById(R.id.ranking); // RA
            mBookTitle = (TextView) view.findViewById(R.id.book_title);
            mBookAuthor = (TextView) view.findViewById(R.id.book_author);
            mBookDescription = (TextView) view.findViewById(R.id.book_description); // RA
            mBookImage = (ImageView) view.findViewById(R.id.book_image); // RA
        }
